    ...
    <section className="pt-28 pb-20 bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-slate max-w-none space-y-6 text-[#4A5568] leading-relaxed">
          <p>
            En <strong className="text-[#0D1B4B]">bvyon marketing</strong> (RUT individual de Bastian Vega Yon, Antofagasta, Chile) nos comprometemos a proteger la privacidad de quienes visitan nuestro sitio web y se ponen en contacto con nosotros.
          </p>

          <h2 className="text-xl font-bold text-[#0D1B4B] mt-8">1. Datos que recopilamos</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#0D1B4B] mt-8">2. Uso de los datos</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#0D1B4B] mt-8">3. Cookies y analítica</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#0D1B4B] mt-8">4. Tus derechos</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#0D1B4B] mt-8">5. Actualizaciones</h2>
          <p>
