              ...
              <div className="bg-[#F7F9FC] rounded-2xl p-6">
                ...
                <ul className="space-y-3 text-sm text-[#4A5568]">
                  <li className="flex gap-3 items-center">
                    <svg aria-hidden="true" className="w-5 h-5 text-[#FF6B2B] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <a href="mailto:metrilabcl@gmail.com" className="hover:text-[#0D1B4B]">
                  ...
                  <li className="flex gap-3 items-center">
                    ...
                    <a href="tel:+56937441215" className="hover:text-[#0D1B4B]">
                      +56 9 3744 1215
                    </a>
                  </li>
                  <li className="flex gap-3 items-center">
