  ...
  return (
    <section className="pt-28 pb-20 bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-[#4A5568] mb-8 text-sm">Última actualización: mayo 2025</p>

        <div className="prose prose-slate max-w-none space-y-6 text-[#4A5568] leading-relaxed">
          <p>
            Al acceder y utilizar el sitio web de <strong className="text-[#0D1B4B]">bvyon marketing</strong> aceptas los presentes términos. Si no estás de acuerdo, te pedimos que no utilices el sitio.
          </p>

          <h2 className="text-xl font-bold text-[#0D1B4B] mt-8">1. Objeto del sitio</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#0D1B4B] mt-8">2. Propiedad intelectual</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#0D1B4B] mt-8">3. Limitación de responsabilidad</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#0D1B4B] mt-8">4. Servicios contratados</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#0D1B4B] mt-8">5. Ley aplicable</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#0D1B4B] mt-8">6. Contacto</h2>
          <p>
            Para consultas sobre estos términos, escríbenos a{" "}
            <a href="mailto:metrilabcl@gmail.com" className="text-[#FF6B2B] hover:underline">
        ...
        <div className="mt-12">
          <Link
            href="/"
            className="inline-block px-6 py-3 bg-[#0D1B4B] text-white font-semibold rounded-xl hover:bg-[#0a1540] transition-colors text-sm"
          >
            Volver al inicio
          </Link>
        </div>
