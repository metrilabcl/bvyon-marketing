...
# Metadatos internos — NUNCA renderizar en UI.
...
El detalle del proceso SEO de este proyecto está documentado en nuestro [caso de triplicación de tráfico en empresa de servicios mineros](/blog/casos/empresa-minera-seo).
